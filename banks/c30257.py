...
REAL.append(realq(
    ...
    cites=[cite("L12", 52, "Alternative approaches to cash flow representation")],
...
HARD.append(hq(id="30257-L12-04", deck="L12", topic="Uncertainty, flexibility and how to represent risk in a DCF", objective="Value and uncertainty",
    ...
    cites=[cite("L12", 46, "Firms and management are subjected to change, but also influence and generate risk and uncertainty"),
           cite("L12", 48, "The level of uncertainty"), cite("L12", 51, "Value generated by new choices and opportunities")],
...
UNITS = {
    "L12": [U("L12-U1", "L12A", "Users and uses of valuation (banks, advisors, PE/VC, strategic investors, appraisers); equity research, M&A report, fairness opinion", "slides 3–8"),
            ...
            U("L12-U13", "L12C", "Investment value; the apartment example", "slides 42–44"),
            U("L12-U14", "L12D", "Predictability, the risk process, scenarios", "slides 46–47, 49"),
            U("L12-U15", "L12D", "Static vs dynamic standpoint; value of a new venture; representing risk in CF or rate", "slides 48, 50–52"),
            U("L12-U0", "L12A", "Tables of contents", "slides 2, 9, 12, 15, 19, 30, 34, 36, 38, 45", False, "Navigation only.")],
