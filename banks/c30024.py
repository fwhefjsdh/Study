...
UNITS = {
    "S1": [U("S1-U1", "S1A", "Mission: FSA, accounting quality and valuation as complementary tools", "slides 2–3"),
           ...
           U("S1-U3", "S1B", "Juventus–Aston Villa: connected transactions across two reporting periods", "slides 6–8"),
           U("S1-U4", "S1B", "Apple: the CFO as a strategic business partner", "slide 9"),
           U("S1-U5", "S1B", "General Electric and Carillion: delayed impairment and aggressive estimates", "slides 10–13"),
           U("S1-U6", "S1B", "Credit Suisse and Macy's: material misstatement vs material weakness; adverse ICFR opinion", "slides 14–18"),
           U("S1-U7", "S1B", "Armani and Prada–Versace: multiples, price vs value", "slides 19–21"),
           U("S1-U8", "S1A", "Conclusion: what financial statements really tell us", "slides 22–23"),
           U("S1-U9", "S1A", "Course organisation: materials, attending status, assessment", "slides 24, 26–32", False, "Course administration, not examinable content."),
           U("S1-U10", "S1C", "Share issue: par value, paid-in capital, contribution in kind", "slide 25; handout Q1"),
           U("S1-U11", "S1C", "Bond issue and accrued interest", "slide 25; handout Q2"),
           U("S1-U12", "S1C", "Rent paid in advance (pre-paid expense)", "slide 25; handout Q3"),
           U("S1-U13", "S1C", "Disposal of a non-current asset: gain or loss", "slide 25; handout Q4"),
           U("S1-U14", "S1C", "Inventory purchase with a note payable", "slide 25; handout Q5"),
           U("S1-U15", "S1C", "Cash collected in advance (unearned revenue)", "slide 25; handout Q6"),
           U("S1-U16", "S1C", "Credit sales and accounts receivable", "slide 25; handout Q7")],
    "S2": [U("S2-U1", "S2A", "The pandemic's effect on Italian listed companies (ROA, ROE, industries)", "slides 2–4"),
           U("S2-U2", "S2A", "Accounting as valuable information: benefits of accounting quality", "slide 7"),
           U("S2-U3", "S2A", "Financial vs managerial accounting", "slide 8"),
           U("S2-U4", "S2A", "Purpose of financial statements, users, cost constraint and materiality", "slides 9–13"),
           U("S2-U5", "S2A", "Accounting standards: purpose, convergence, IFRS and US GAAP", "slides 14–15"),
           U("S2-U6", "S2B", "What FSA enables; fundamental analysis", "slides 16, 23"),
           U("S2-U7", "S2B", "Investment styles: intuitive, passive, fundamental", "slide 17"),
           U("S2-U8", "S2B", "Price vs value (market, investment, intrinsic) and mispricing", "slides 18–20"),
           U("S2-U9", "S2B", "Efficient markets, the semi-strong form and reporting", "slides 21–22"),
           ...
           U("S2-U12", "S2C", "Balance sheet items and measurement (cash, receivables, inventories, PP&E, financial assets, intangibles, liabilities)", "slides 29–32 (optional)"),
           U("S2-U13", "S2C", "Equity: book vs market value, market premium", "slide 33"),
           U("S2-U14", "S2C", "Income statement: definitions and the functional format", "slides 34–35"),
           U("S2-U15", "S2C", "Income statement principles: revenue recognition, accruals, recognition uncertainty", "slide 36"),
           U("S2-U16", "S2C", "Statement of shareholders' equity and retained earnings", "slide 37"),
           U("S2-U17", "S2C", "Cash flow statement: CFO, CFI, CFF; direct and indirect methods", "slides 38–40"),
           U("S2-U18", "S2C", "Reconciliation of cash and the interrelation of the statements", "slides 41–42"),
           U("S2-U19", "S2C", "Fiat Chrysler: the statements of a real company", "slides 43–47", False, "Illustration: the statements are shown as images with no figures in the text; the lesson (read the notes, connect the statements) is examined through S2-U18."),
           U("S2-U20", "S2D", "Reverse accounting distortions: judgement vs earnings management", "slide 48"),
           U("S2-U21", "S2D", "Distortions in assets (leases, R&D, fair values, depreciation, allowances)", "slide 49"),
           U("S2-U22", "S2D", "Distortions in liabilities and equity (provisions, leases, employment benefits, share-based payments)", "slide 50"),
           U("S2-U23", "S2D", "Distortions in the income statement (revenue recognition, gift cards, deferred expenses)", "slide 51"),
           U("S2-U24", "S2D", "Accrued and deferred revenues and expenses", "slides 52–53")],
    "S34": [U("S34-U1", "S34A", "Why reclassify; objectives; no prescribed format", "slides 3–8"),
            U("S34-U2", "S34A", "Operating NWC: definition and interpretation (negative ONWC)", "slides 9–11"),
            U("S34-U3", "S34A", "Net Invested Capital: asset side and financing side", "slides 12–14"),
            U("S34-U4", "S34A", "Net Financial Position: items included and excluded", "slides 13–14, 23–26"),
            U("S34-U5", "S34A", "Operating vs non-operating assets; non-operating fixed assets excluded from NIC; ROIC consistency", "slides 15–17"),
            U("S34-U6", "S34A", "ONWC items included and excluded; borderline cases", "slides 27–31"),
            U("S34-U7", "S34B", "Liquidity-based balance sheet: classification by liquidity and maturity", "slides 18–20"),
            U("S34-U8", "S34B", "Financial NWC and treasury margin; interpretation", "slides 21–22"),
            U("S34-U9", "S34C", "Income statement reclassification: the three methods and EBIT", "slides 32–34"),
            U("S34-U10", "S34C", "Cost of sales (destination): COGS, cost drivers, gross margin %", "slides 35–39"),
            U("S34-U11", "S34C", "Value added (nature): value of production, external/internal costs, distribution, VA ratio, outsourcing", "slides 40–48"),
            U("S34-U12", "S34C", "Contribution margin (behaviour): variable/fixed costs, CVP uses", "slides 49–51")],
}
